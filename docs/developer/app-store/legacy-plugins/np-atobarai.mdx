...
We are moving towards supporting the most popular payment gateways. For Japan, we recommend using the [Adyen App](developer/app-store/apps/adyen/overview.mdx) or [NP Atobarai App](developer/app-store/apps/np-atobarai/overview.mdx) instead.
:::
