...
Tax classes are needed when some products require different tax rates than the default country rate. 
For example, if you sell healthcare products in Poland that are taxed at 8% instead of the standard 23%, you need a tax class for them. 
If all your products use the same tax rate, you can skip this step.
...
You can use different tax calculation methods for different countries within the same channel. 
For example, use flat rates for EU countries and dynamic taxes for the US:

**In Dashboard:**
1. Go to **Configuration → Taxes**
2. Select your **channel**
3. Scroll down to the **Country exceptions** section
4. Click **Add country** or edit an existing country configuration
5. Select the country you want to configure
6. Set the **Method of tax calculation** for that country (flat rates or a specific tax app)
7. Configure other tax settings for that country if needed (charge taxes, display gross prices, etc.)
8. Save the configuration
9. Repeat for each country that needs a different tax calculation method
