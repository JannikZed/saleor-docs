...
If you are a Saleor Cloud user, you need to add `saleor-cloud-pubsub@saleor-cloud-286109.iam.gserviceaccount.com` to the list of permitted publishers of the queue in question.

If you are self-hosting, you need to set the [`GOOGLE_APPLICATION_CREDENTIALS` environment variable](https://cloud.google.com/pubsub/docs/quickstart-client-libraries).
